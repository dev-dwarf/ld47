...
if cardSel_active && (cardSel_state == "cards_view_debuff" or cardSel_state == "card_select")
{
	var _sel_count = 0;
	with obj_card
	...
	draw_text_float(room_width / 2, room_height - 65, true, _str, global.font_large, tt_text, 2);
}

if tt_flash > 0 && cardSel_state == "card_select"
{
	draw_set_color(C_yellow);
	draw_text_float(room_width / 2, (room_height - 85) + error_off, true, "!! - select at least one card - !!", global.font_large, tt_text, 2);
