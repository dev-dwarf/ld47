...
x = lerp(x, oPlayer.x + lengthdir_x(offset_amount, offset_angle), 0.8);
y = lerp(y, oPlayer.y + lengthdir_y(offset_amount, offset_angle), 0.8);
...
if (oPlayer.state == player_states.dash or oPlayer.dash_not_ready) {
	...
	target_angle = -cos_offset_angle*swing_angle*swing_flip*swing_amount - 80 * cos_offset_angle
}
